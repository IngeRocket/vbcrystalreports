...
Public Class reporteTejido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "vbcrystalreports.reporteTejido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedreporteTejido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reporteTejido = New reporteTejido()
        rpt.Site = Me.Site
        Return rpt
    End Function
